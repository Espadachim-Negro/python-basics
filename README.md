...
## Chapter 5 — Debugging (отладка)

Практика отладки в VS Code

Что изучил:
- Генерицаию исключений raise
- Логирование
- Breakpoints (красные точки)
- F5 — запуск отладки
- F10 — шаг вперёд
- F11 — шаг внутрь
- Просмотр переменных в реальном времени
- Поиск ошибок типов, логики, циклов

Примеры:
1skript - Ошибка была в диапазоне
2skript - Отсутсвовал код увелечения переменной поэтому был бесконечный цикл
3skript - Переменной basket присваивается список - изменяемый обьект
4skript - Лишняя не нужная запись
